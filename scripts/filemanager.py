#!/usr/bin/env python3
"""
PyQt5 File Manager with LIVE Pywal theming + Hover Preview + Nerd Font Icons
...
from PyQt5.QtWidgets import (
    ...
    QSizePolicy, QStyleFactory, QToolTip
)
...
class FileManager(QMainWindow):
    ...
    def initUI(self):
        ...
        # Toolbar
        bar = QHBoxLayout()
        self.btn_back = QPushButton("󰁍 Back"); self.btn_back.setFont(icon_font); self.btn_back.clicked.connect(self.go_back); self.set_instant_tooltip(self.btn_back, "Back")
        self.btn_home = QPushButton("󰋜 Home"); self.btn_home.setFont(icon_font); self.btn_home.clicked.connect(self.go_home); self.set_instant_tooltip(self.btn_home, "Home")
        self.btn_refresh = QPushButton("󰑐 Refresh"); self.btn_refresh.setFont(icon_font); self.btn_refresh.clicked.connect(self.refresh); self.set_instant_tooltip(self.btn_refresh, "Refresh")
        ...
        self.set_instant_tooltip(self.btn_hidden, "Show Hidden Files")
        ...
        for b, t in [(self.btn_copy,"Copy selected files"),(self.btn_cut,"Cut selected files"),
                     (self.btn_paste,"Paste files from clipboard"),(self.btn_delete,"Delete selected files")]:
            b.setFont(icon_font)
            self.set_instant_tooltip(b,t)
