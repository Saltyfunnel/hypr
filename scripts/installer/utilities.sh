...
run_command "cp -r /home/$SUDO_USER/simple-hyprland/assets/backgrounds/* /home/$SUDO_USER/.config/assets/backgrounds/" "Copy background images" "yes" "no"
...
run_command "cp -r /home/$SUDO_USER/simple-hyprland/configs/wlogout /home/$SUDO_USER/.config/" "Copy Wlogout config" "yes" "no"

# Ensure wlogout assets folder exists and copy contents properly
run_command "mkdir -p /home/$SUDO_USER/.config/assets/wlogout" "Create wlogout assets dir" "no" "no"
run_command "cp -r /home/$SUDO_USER/simple-hyprland/assets/wlogout/* /home/$SUDO_USER/.config/assets/wlogout/" "Copy Wlogout assets" "yes" "no"
