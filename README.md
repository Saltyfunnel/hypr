...
The Waybar custom/clockweather module fetches temperature via wttr.in. To change the location to your own city, replace YOUR_CITY in the command string inside your Waybar config (~/.config/waybar/config.jsonc):
