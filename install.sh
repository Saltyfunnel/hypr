...
APP_PACKAGES=(mpv imv pavucontrol btop gnome-disk-utility)
...
sudo -u "$USER_NAME" yay -S --noconfirm python-pywal16 zen-browser-bin nordzy-cursors\
    > /tmp/hypr_install_log 2>&1 &
spinner "$!" "Installing pywal16, zen browser, and nordzy cursors"
