...
install_pacman_packages() {
    ...
    PACMAN_PACKAGES=(
        ...
        qt5-wayland qt6-wayland slurp smartmontools vwsm wget wireless-tools rofi
        wpa_supplicant xdg-desktop-portal-hyprland xdg-utils lite-xl firefox
        thunar gvfs gvfs-mtp gvfs-gphoto2 gvfs-smb udisks lxappearance
        thunar-archive-plugin thunar-volman ffmpegthumbnailer file-roller tumbler
        python-pywal python-gobject gtk3 sddm yazi fastfetch tar mpv
    )
